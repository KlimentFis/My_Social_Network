# Generated by Django 5.1.1 on 2024-11-21 21:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(verbose_name='Обо мне')),
                ...
                ('subscribers', models.ManyToManyField(blank=True, related_name='user_subscribers', to=settings.AUTH_USER_MODEL, verbose_name='Подписчики')),
                ('subscriptions', models.ManyToManyField(blank=True, related_name='user_subscriptions', to=settings.AUTH_USER_MODEL, verbose_name='Подписки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_author', to=settings.AUTH_USER_MODEL, verbose_name='Автор поста')),
            ],
        ),
        migrations.CreateModel(
            name='Post_Image',
